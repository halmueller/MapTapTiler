//
//  SolidOverlayViewController.swift
//  Tiler Example
//
...
class SolidOverlayViewController: UIViewController {
    ...
    let USGSTopo = MapSourceDescription(name: "USGS Topo",
                                               attribution: "USGS",
                                               isOpaque: true,
    ...
    func configureSolidBasemap() {
        ...
        self.mapView.mapType = USGSTopo.appleMapType
        
        // no need for these, they won't be visible
        self.mapView.pointOfInterestFilter = .excludingAll
        
        overlay = ExternalTileOverlay(sourceDescription: USGSTopo)
